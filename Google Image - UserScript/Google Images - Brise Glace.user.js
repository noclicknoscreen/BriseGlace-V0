// ==UserScript==
//This script is based on http://userscripts-mirror.org/scripts/source/78355.user.js
// It allows clicked image to be sent to the Brise Glace device : http://garemixsaintpaul.grandlyon.com/index.php/les-brise-glace/
// @name           Google Images - Brise Glace
...
if ( imgTable ) { // for basic version
  ...
  var fixImageBox = function(image){
    ...
    if (span !== null) {
      ...
      var searchKeywords = document.getElementById('lst-ib').value;
      //a.href = "http://localhost/BriseGlace/index.php?type=add&imgUrl="+links.toImgHref;
      a.href = "http://localhost/BriseGlace/addTopic.php?imgUrl="+links.toImgHref+"&key="+searchKeywords;
  ...
  for (var i = 0 ; i < similars.length ; i++){
	...
	var newA = document.createElement('a');
      newA.href = "http://localhost/briseGlace/index.php?imgUrl="+href.toImgHref;
